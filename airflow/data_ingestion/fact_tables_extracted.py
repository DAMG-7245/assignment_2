...
import csv
import sys
# 找到 /opt/airflow 目录并添加到 sys.path
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))         # /opt/airflow/data_ingestion
AIRFLOW_BASE = os.path.abspath(os.path.join(CURRENT_DIR, ".."))  # /opt/airflow
if AIRFLOW_BASE not in sys.path:
    sys.path.insert(0, AIRFLOW_BASE)
